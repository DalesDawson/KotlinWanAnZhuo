package com.e006.kotlin_kaiyan.fragment
...
import com.e006.release.base.BaseFragment
import com.e006.release.R
import com.e006.release.activity.CommonWebViewActivity
import com.e006.release.activity.SearchListActivity
import com.e006.release.bean.HotData
import com.e006.release.bean.HotSearchResponse
    ...
    override fun initView() {
        search_tv.setOnClickListener {
            if (!TextUtils.isEmpty(search_view.text.toString())) {
                Logger.d("TAG", search_view.text.toString())
    ...
    private fun getHotWord() {
        Okkt.instance.Builder().setUrl(HttpProvider.HOT_WORD).get(object : CallbackRule<HotSearchResponse> {
            override suspend fun onSuccess(entity: HotSearchResponse, flag: String) {
                Logger.d("HOT_WORD---", entity.toString())
    ...
    private fun getHotWeb() {
        Okkt.instance.Builder().setUrl(HttpProvider.HOT_FRIEND)
            .get(object : CallbackRule<HotSearchResponse> {
                override suspend fun onSuccess(entity: HotSearchResponse, flag: String) {
                    Logger.d("HOT_FRIEND---", entity.toString())
